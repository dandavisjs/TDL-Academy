  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.main}>
        ...
        <div>
          <p style={{ color: "#D35058" }}>Платформа работает в бета-тестовом режиме. Если вы обнаружили неполадки, вы можете оповестить нас по электронной почте: contact{`<собака>`}truckdriver.help</p>
